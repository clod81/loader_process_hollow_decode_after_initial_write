...
namespace ConsoleApp1
{
	class Program
	{
		...
		[DllImport("kernel32.dll")]
		static extern bool ReadProcessMemory(IntPtr hProcess, IntPtr lpBaseAddress, byte[] lpBuffer, Int32 nSize, out IntPtr lpNumberOfBytesWritten);
		...
		static void Main()
		{
			...
			WriteProcessMemory(hProcess, addressOfEntryPoint, buf, size, out nRead);
			...
			{
				ptr = IntPtr.Add(addressOfEntryPoint, i);
				ReadProcessMemory(hProcess, ptr, baite, 1, out nRead);
